    ...
    return (
        <div>
            ...
            {error?.message && <p className='text-sm text-red-500'>{error.message.toString()}</p>} */}
                    ...
                    <div className='justify-center self-center min-w-[200px] '>
                        <label className='text-xs text-gray-500 flex items-center gap-2 cursor-pointer ' htmlFor='imag'>
                            <Upload />
                            <span>Upload a photo</span>
                        </label>
                        <input id='imag' type="file" {...register("imag")} className='hidden' />
                        {
                            errors.imag?.message && (
